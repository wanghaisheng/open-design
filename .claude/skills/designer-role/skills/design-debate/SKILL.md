...
- **Called by:** `design-strategy`, `design-discovery` (when user requests debate), `design-critic` (when "rethink" is recommended)
...
- **Pairs with:** `design-strategy`, `design-memory`, `taste-feedback`, `tradeoff-analysis`
